...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('AdminBlogBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('Admin\BlogBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('Admin\BlogBundle\Form\TagType', $tag);
