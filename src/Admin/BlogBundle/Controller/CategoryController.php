...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('AdminBlogBundle:Category')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\BlogBundle\Form\CategoryType', $category);
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        $editForm = $this->createForm('Admin\BlogBundle\Form\CategoryType', $category);
